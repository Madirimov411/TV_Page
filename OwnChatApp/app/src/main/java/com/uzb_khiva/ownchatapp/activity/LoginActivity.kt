...
import com.uzb_khiva.ownchatapp.R
import com.uzb_khiva.ownchatapp.ui.theme.OwnChatAppTheme
import com.uzb_khiva.ownchatapp.util.Constants
import com.uzb_khiva.ownchatapp.viewmodel.LoginViewModel
            ...
            viewModel.loginEvent.collect { event ->
                when (event) {
                    is LoginViewModel.LogInEvent.ErrorInputTooShort -> {
                        showToast("Invalid! Enter more than ${Constants.MIN_USERNAME_LENGTH} characters.")
                    }
